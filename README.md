...
### Summary
Subs is a Unity training environment that trains WWII Destroyers the MLAgents machine learning toolkit to protect their precious convoys from vicious, decision-tree Uboat AI.  
