...
public class SearcherBox : MonoBehaviour
{
    ...
    public void ResetScene()
    {
        ...
        SearcherAgent agent = agentShip.GetComponent<SearcherAgent>();
      ...
      //  float yPos = Random.Range(-agent.uboatMaxPlacementRange, agent.uboatMaxPlacementRange);
        ...
        // place at random x north of destroyer
        enemyShip.transform.localPosition = new Vector3(xPos/2f, agentShip.transform.position.y + agentShip.GetComponent<Lookout>().rangeMax  + 0.3f, enemyShip.transform.localPosition.z);
